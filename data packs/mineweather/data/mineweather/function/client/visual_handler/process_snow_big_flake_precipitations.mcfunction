#
# mineweather:client/visual_handler/process_snow_big_precipitations
#
...
execute if score ::mineweather::const REDUCE_PARTICLES = ::const FALSE run execute store result storage io: count int 1.0 run data get storage io: point_weather_data_descriptor.precipitations_snow 0.5
execute if score ::mineweather::const REDUCE_PARTICLES = ::const TRUE run execute store result storage io: count int 1.0 run data get storage io: point_weather_data_descriptor.precipitations_snow 0.25
...
data modify storage io: particle set value "minecraft:spit"
data modify storage io: particle_area_height set value 1.28f
