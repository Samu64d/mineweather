#
# mineweather:weather_runtime/core/global_climate_system/relax_temperature/y_loop
#
...
execute if score ::mineweather::weather_runtime::core::global_climate_system y < ::mineweather::weather_runtime::core::global_climate_system height run function mineweather:weather_runtime/core/global_climate_system/relax_temperature/y_loop
