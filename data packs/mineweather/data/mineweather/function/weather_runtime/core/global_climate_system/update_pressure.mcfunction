#
# mineweather:weather_runtime/core/global_climate_system/update_pressure
#
# Update the pressure of a global climate system
#> Storage
...
function mineweather:weather_runtime/core/global_climate_system/update_pressure/x_loop
