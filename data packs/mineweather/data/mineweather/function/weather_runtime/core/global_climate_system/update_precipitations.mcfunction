#
# mineweather:weather_runtime/core/global_climate_system/update_precipitations
#
# Update the precipitations of a global climate system
#> Storage
...
function mineweather:weather_runtime/core/global_climate_system/update_precipitations/x_loop
